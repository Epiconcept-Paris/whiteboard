...
/**
 * List of properties for each type of visualisation
 * @type {*[]}
 */
var visualGallery = [
  {
...
/**
 * List of action buttons for a visual
 */
var actionButtons = [
...
var properties = [
  {
    "title": "Filtres", "elements": [
      ...
      , {
        ...
        "renderAs": "list",
        "value": "France",
        "values": ["France", "Chili", "Espagne", "Catalogne"]
        ,
        "properties": [
          {"type": "dropdownlist", "label": "Display as", "values": ["Textbox", "List"], "value": "List"}
          ...
          , {
            "type": "list",
            "label": "Connections",
            "values": ["Table 1[\"countrycode\"]", " Table 2[\"countrycode\"]"]
          }
        ]
      }
      , {
